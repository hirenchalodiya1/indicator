...
class WilliamsRStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.will = bt.ind.WilliamsR(period=3)
    ...
    def getsizing(self, data=None, isbuy=None):
        if isbuy:
            self.stakes = min(int(self.cerebro.broker.getcash() // self.data_open[0]), float('inf'))
        return self.stakes
